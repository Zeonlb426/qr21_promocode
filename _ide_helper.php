 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \Dvlp\ExtendedPagination\ExtendedPaginationServiceProvider::registerOffsetPaginateMacro()
         * @param mixed $perPage
         * @param mixed $columns
         * @param array $options
         * @static 
         */ 
        public static function offsetPaginate($perPage = null, $columns = [], $options = [])
        {
                        return \Illuminate\Database\Query\Builder::offsetPaginate($perPage, $columns, $options);
        }
...
namespace  { 
            ...
            public static function offsetPaginate($perPage = null, $columns = [], $options = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::offsetPaginate($perPage, $columns, $options);
            }
